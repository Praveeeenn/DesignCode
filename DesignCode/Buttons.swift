...
struct CircleButton: View {
    ...
    var body: some View {
        ...
        .background(
            ZStack {
                LinearGradient(gradient: Gradient(colors: [Color(press ? #colorLiteral(red: 0.7826909602, green: 0.8428925136, blue: 0.9561296371, alpha: 1) : #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)), Color(press ? #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0) : #colorLiteral(red: 0.7826909602, green: 0.8428925136, blue: 0.9561296371, alpha: 1))]), startPoint: .topLeading, endPoint: .bottomTrailing)
                Circle()
                    .stroke(Color.clear, lineWidth: 10)
                    .shadow(color: Color(press ? #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0) : #colorLiteral(red: 0.7826909602, green: 0.8428925136, blue: 0.9561296371, alpha: 1)), radius: 3, x: -5, y: -5)
                Circle()
                    .stroke(Color.clear, lineWidth: 10)
                    .shadow(color: Color(press ? #colorLiteral(red: 0.7826909602, green: 0.8428925136, blue: 0.9561296371, alpha: 1) : #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)), radius: 3, x: 3, y: 3)
            }
        )
            .clipShape(Circle())
            .shadow(color: Color(press ? #colorLiteral(red: 0.7826909602, green: 0.8428925136, blue: 0.9561296371, alpha: 1) : #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)), radius: 20, x: -20, y: -20)
            .shadow(color: Color(press ? #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0) : #colorLiteral(red: 0.7826909602, green: 0.8428925136, blue: 0.9561296371, alpha: 1)), radius: 20, x: 20, y: 20)
...
struct PayButton: View {
    ...
    var body: some View {
        ...
        .overlay(
            Circle()
                .trim(from: tap ? 0.0001 : 1.0, to: 1.0)
                .stroke(
                    LinearGradient(gradient: Gradient(colors: [Color(#colorLiteral(red: 0.3647058904, green: 0.06666667014, blue: 0.9686274529, alpha: 1)), Color(#colorLiteral(red: 0.4745098054, green: 0.8392156959, blue: 0.9764705896, alpha: 1))]), startPoint: .topLeading, endPoint: .bottomTrailing)
                    , style: StrokeStyle(lineWidth: 4.0, lineCap: .round))
                .frame(width: 80, height: 80)
                .rotationEffect(Angle(degrees: 90.0))
            .rotation3DEffect(Angle(degrees: 180), axis: (1, 0, 0))
                .shadow(color: Color(#colorLiteral(red: 0.3647058904, green: 0.06666667014, blue: 0.9686274529, alpha: 1)).opacity(0.3), radius: 5.0, x: 3.0, y: 3.0)
                .animation(.easeInOut)
