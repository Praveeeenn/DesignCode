...
struct RingView: View {
    var body: some View {
        ZStack {
            Circle()
                .stroke(Color.black.opacity(0.1), style: StrokeStyle(lineWidth: 5.0))
            ...
            Circle()
                ...
                .stroke(
                    ...
                    style: StrokeStyle(lineWidth: 5.0, lineCap: .round, lineJoin: .round, miterLimit: .infinity, dash: [20, 0], dashPhase: 0))
