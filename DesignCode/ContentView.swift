        ...
        ZStack {
            ...
            .gesture(
                DragGesture()
                    ...
                    .onEnded({ (value) in
                        if self.bottomState.height > 190 {
                            self.showCard = false
                        }
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            Text("This certificate is proof that Praveen has achieved the UI Design course with approval from Google.")
                ...
                .lineSpacing(4)
            HStack {
                RingView(color1: #colorLiteral(red: 0.4745098054, green: 0.8392156959, blue: 0.9764705896, alpha: 1), color2: #colorLiteral(red: 0.3647058904, green: 0.06666667014, blue: 0.9686274529, alpha: 1), widthAndHeight: 88.0, percent: 75, show: $showRing)
